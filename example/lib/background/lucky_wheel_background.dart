...
class _LuckyWheelBackgroundState extends State<LuckyWheelBackground>
  ...
  void initState() {
    ...
    _painterController.addListener(() async {
      if (_painterController.isPlay) if (_painterController.isLoop) {
        _controller.repeat();
      } else if (!_creatingCompleter.isCompleted) {
        _controller.reset();
        _controller.forward();
      }
    });
